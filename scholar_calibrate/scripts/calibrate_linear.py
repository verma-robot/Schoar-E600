...
from scholar_calibrate.cfg import CalibrateLinearConfig
import tf
...
class CalibrateLinear():
    def __init__(self):
        ...
        self.linear_speed_calibrate_factor_temp = rospy.get_param('~linear_speed_calibrate_factor_temp', 1.0)
...
# The odom frame is usually just /odom
        ...
        while not rospy.is_shutdown():
            ...
            if self.start_test:
                ...
                distance *= self.linear_speed_calibrate_factor_temp
    ...
    def dynamic_reconfigure_callback(self, config, level):
        ...
        self.linear_speed_calibrate_factor_temp = config['linear_speed_calibrate_factor_temp']
