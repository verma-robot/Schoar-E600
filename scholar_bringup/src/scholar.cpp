...
void Mobile_robot::writeSpeedCommand(double linear_speed, double angular_speed)
{
     ...
     right_wheel_rate = (60 * linear_speed * scholar_linear_speed_factor + 30 * scholar_wheel_track * angular_speed * scholar_angular_speed_factor) * 10 / (PI * scholar_wheel_diameter);
     left_wheel_rate = (60 * linear_speed * scholar_linear_speed_factor - 30 * scholar_wheel_track * angular_speed * scholar_angular_speed_factor) * 10 / (PI * scholar_wheel_diameter);
    ...
    {   
             ...
             if ( buffer_data[1] != 0x03 || buffer_data[2] != 0x01 || buffer_data[3] != 0x0C || (buffer_data[16] != 0x6D) )
             ...
             else if(buffer_data[4] == 0x04 )//read
              {
                  ...
                  vx /= scholar_linear_speed_factor;

                  vth = -1 * PI * scholar_wheel_diameter * (read_right_wheel_speed - read_left_wheel_speed) / (600 * scholar_angular_speed_factor * scholar_wheel_track);
